...
namespace TLM.EHC.API.Swagger.ResponseBodyExampleProviders
{
    ...
    public class EpisodeIdNotFoundExampleProvider : BodyExampleProvider
    {
        protected override void CreateExamples()
        {
            ...
            if (isPaged)
            {
                ...
                AddErrorExample(EhcEpisodeErrorExample.EpisodeNotFound("episodeid", "34asdjkas1"), "Provide correct EpisodeID");
            }
